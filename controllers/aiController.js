...
const parseInvoiceFromText = async (req, res) => {
    ...
    try {
        const prompt = `
        You are an expert invoice data extraction AI. Analyze the following text and extract the relevant information to create an invoice in indian rupee currency.
...
const generateReminderEmail = async (req, res) => {
    ...
    try {
        ...
        const prompt = `
        You are a professional and polite accounting assistant. Write a friendly remider email to a client about an overdue or upcoming invoice payment indian rupee currency
        ...
        The tone should be friendly but clear and short. Keep it concise. Start the email with "Subject:".
        `;
...
const getDashboardSummary = async (req, res) => {
    ...
    try {
        ...
        Based on the following summary of their indian rupee currency invoice data, provide 2-3 concise and actionable insigths.
        Each insight should be a short in a JSON array.
        ...
        Return your response as a valid object with a single key "insights" which is an array of strings.
