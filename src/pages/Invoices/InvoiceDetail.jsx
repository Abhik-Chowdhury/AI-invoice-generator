        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start pb-8 border-b border-slate-200">
            ...
            <div className="text-left sm:text-right mt-4 sm:mt-0">
              ...
              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs text-right font-medium ${invoice.status === 'Paid' ? 'bg-emerald-100 text-emerald-800' :
          ...
          <div className="mt-0.5 bg-white border border-slate-200 rounded-lg overflow-hidden">
            <table className="w-full divide-y divide-slate-200">
              <thead className="bg-slate-50">
                <tr>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Product</th>
