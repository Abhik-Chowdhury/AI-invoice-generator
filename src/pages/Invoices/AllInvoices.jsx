...
import { Loader2, Trash2, Edit, Search, FileText, Plus, AlertCircle, Mail, Sparkles } from 'lucide-react';
...
const AllInvoices = () => {
  ...
  const [statusChangeLoading, setStatusChangingLoading] = useState(null);
  ...
  const handleStatusChange = async (invoice) => {
    ...
    try {
      ...
      setStatusChangingLoading(null);
    }
  };

  const handleOpenReminderModal = (invoiceId) => {
    // console.log('MAIL CLICKED, INVOICE ID:', invoiceId);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-1">Manage all your invoices in once place</p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative grow">
              ...
              <input
                ...
                className="w-full h-10 pl-10 pr-4 py-2 border border-slate-200 rounded-lg bg-white text-slate-900 placeholder-slate-400 focus:outline-non focus:ring-2 focus:ring-blue-500"
                value={searchTerm}
