      ...
      <div className="w-full max-w-sm">
        ...
        <div className="relative">
          ...
          <input
            ...
            onBlur={handleBlur}
            className={`w-full pl-12 pr-4 py-3 border rounded-lg focus-lg focus:ring-2 focus:border-transparent outline-none transition-all ${fieldErrors.email && touched.email
