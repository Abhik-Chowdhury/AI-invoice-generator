...
import { Loader2, FileText, IndianRupee, Plus, icons } from "lucide-react";
...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Recent Invoices */}
      <div className="w-full bg-white border border-slate-200 rounded-lg shadow-sm shandow-gray-100 overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <Button size="large" onClick={() => navigate("/invoices/new")} icon={Plus}>
            Create Invoice
          </Button>
        </div>
        )}
