...
const Button = ({
    ...
    ...props}) => {
        ...
        const variantClasses = {
            ...
            secondary: 'bg-white hover:bg-state-50 text-state-700 border border-state-200',
            ghost: 'bg-transparent hover:bg-state-100 text-state-700',
        };

        const sizeClasses = {
            small: 'px-3 py-1 h-8 text-sm',
            medium: 'px-4 py-2 h-10, text-sm',
            large: 'px-6 py-6 h-12 text-base',
        };
